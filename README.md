# Ajuste-Art-13-IVA-en-SOS-Contador

Script para realizar masivamente el ajuste del Art 13 de IVA con los datos de compras y ventas anuales obtenidos del reporte de SOS-Contador
